...
assert
    ...
    %v1 <= [Q2, Q2, Q2, Q2, Q2, Q2, Q2, Q2] /\
    %v2 <= [Q2, Q2, Q2, Q2, Q2, Q2, Q2, Q2] /\
    %v6 <= [Q2, Q2, Q2, Q2, Q2, Q2, Q2, Q2] /\

    %v1 >= [NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2] /\
    %v2 >= [NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2] /\
    %v6 >= [NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2]

    prove with [precondition, algebra solver isl]
  &&
    Q2 = 2295@16 /\ NQ2 = (-2295)@16 /\

    %v1 <=s [Q2, Q2, Q2, Q2, Q2, Q2, Q2, Q2] /\
    %v2 <=s [Q2, Q2, Q2, Q2, Q2, Q2, Q2, Q2] /\
    %v6 <=s [Q2, Q2, Q2, Q2, Q2, Q2, Q2, Q2] /\

    %v1 >=s [NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2] /\
    %v2 >=s [NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2] /\
    %v6 >=s [NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2, NQ2]
...
# assert
#     4 * (%f0_nof14[0] + %f2_nof14[0] + %f3_nof14[0]) - 4591 * %v5[0] <= 32767 /\
#     4 * (%f0_nof14[0] + %f2_nof14[0] + %f3_nof14[0]) - 4591 * %v5[0] >= -32768
#     prove with [algebra solver isl] && true;

# assert
#     4 * (%f0_nof14[0] + %f2_nof14[0] + %f3_nof14[0]) - 4591 * %v5[0] = %v7[0] ( mod [65536] )
#     && true;

# assume 4 * (%f0_nof14[0] + %f2_nof14[0] + %f3_nof14[0]) - 4591 * %v5[0] = %v7[0] && true;
...
# assert
#     (4 * %f0_nof14[0] - %f2_nof14[0] - %f3_nof14[0]) - 4591 * %v5[0] = %v1[0] ( mod [65536] )
#     && true;

# assume (4 * %f0_nof14[0] - %f2_nof14[0] - %f3_nof14[0]) - 4591 * %v5[0] = %v1[0] && true;
...
# assert
#     1005 * (%f2_nof14[0] + %f3_nof14[0]) - 4591 * %v5[0] <= 32767 /\
#     1005 * (%f2_nof14[0] + %f3_nof14[0]) - 4591 * %v5[0] >= -32768
#     prove with [algebra solver isl] && true;

# assert
#     1005 * (%f2_nof14[0] + %f3_nof14[0]) - 4591 * %v5[0] = %v3[0] ( mod [65536] )
#     && true;

# assume 1005 * (%f2_nof14[0] + %f3_nof14[0]) - 4591 * %v5[0] = %v3[0] && true;
...
# assert
#     -818 * (%f2_nof14[0] - %f3_nof14[0]) - 4591 * %v6[0] <= 32767 /\
#     -818 * (%f2_nof14[0] - %f3_nof14[0]) - 4591 * %v6[0] >= -32768
#     prove with [algebra solver isl] && true;

# assert
#     -818 * (%f2_nof14[0] - %f3_nof14[0]) - 4591 * %v6[0] = %v3[0] ( mod [65536] )
#     && true;

# assume -818 * (%f2_nof14[0] - %f3_nof14[0]) - 4591 * %v6[0] = %v3[0] && true;
...
# assert
#     -1736 * (%f2_nof14[0] - %f3_nof14[0]) - 4591 * %v6[0] <= 32767 /\
#     -1736 * (%f2_nof14[0] - %f3_nof14[0]) - 4591 * %v6[0] >= -32768
#     prove with [algebra solver isl] && true;

# assert
#     -1736 * (%f2_nof14[0] - %f3_nof14[0]) - 4591 * %v6[0] = %v2[0] ( mod [65536] )
#     && true;

# assume -1736 * (%f2_nof14[0] - %f3_nof14[0]) - 4591 * %v6[0] = %v2[0] && true;
...
cut (* 2 *)
    %v7[0]  = 4 * (%f0_nof14[0] +        %f2_nof14[0] +        %f3_nof14[0]) ( mod [4591] ) /\
    %v18[0] = 4 * (%f0_nof14[0] - 2113 * %f2_nof14[0] + 1610 * %f3_nof14[0]) ( mod [4591] ) /\
    %v20[0] = 4 * (%f0_nof14[0] - 2274 * %f2_nof14[0] - 1815 * %f3_nof14[0]) ( mod [4591] ) /\
    %v6[0]  = 4 * (%f0_nof14[0] - 1815 * %f2_nof14[0] - 2274 * %f3_nof14[0]) ( mod [4591] ) /\
    %v5[0]  = 4 * (%f0_nof14[0] + 1610 * %f2_nof14[0] - 2113 * %f3_nof14[0]) ( mod [4591] ) /\
