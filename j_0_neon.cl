...
assert
    [4, 4, 4, 4, 4, 4, 4, 4] * (%f1_nof03 + %f2_nof03 + %f4_nof03)
...
assert
    [1005, 1005, 1005, 1005, 1005, 1005, 1005, 1005] * (%f1_nof03 - %f2_nof03 + %f4_nof03)
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v2
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\
...
assert
    [-1736, -1736, -1736, -1736, -1736, -1736, -1736, -1736] * %f2_nof03
    - [918, 918, 918, 918, 918, 918, 918, 918] * (%f1_nof03 - %f4_nof03)
...
assert
    [-1736, -1736, -1736, -1736, -1736, -1736, -1736, -1736] * %f2_nof03
    + [918, 918, 918, 918, 918, 918, 918, 918] * (%f1_nof03 - %f4_nof03)
    - [-818, -818, -818, -818, -818, -818, -818, -818] * (%f1_nof03 + %f2_nof03 - %f4_nof03)
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v2
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\
...
cut (* 3 *)
    ...
    %v17 = [4, 4, 4, 4, 4, 4, 4, 4] * (
        [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %f1_nof03 -
        [ 2113,  2113,  2113,  2113,  2113,  2113,  2113,  2113] * %f2_nof03 -
        [ 2274,  2274,  2274,  2274,  2274,  2274,  2274,  2274] * %f4_nof03
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\

    %v1  = [4, 4, 4, 4, 4, 4, 4, 4] * (
        [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %f1_nof03 -
        [ 2274,  2274,  2274,  2274,  2274,  2274,  2274,  2274] * %f2_nof03 +
        [ 1610,  1610,  1610,  1610,  1610,  1610,  1610,  1610] * %f4_nof03
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\

    %v23 = [4, 4, 4, 4, 4, 4, 4, 4] * (
        [ 1610,  1610,  1610,  1610,  1610,  1610,  1610,  1610] * %f1_nof03 -
        [ 1815,  1815,  1815,  1815,  1815,  1815,  1815,  1815] * %f2_nof03 -
        [ 2113,  2113,  2113,  2113,  2113,  2113,  2113,  2113] * %f4_nof03
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\

    %v2  = [4, 4, 4, 4, 4, 4, 4, 4] * (
        [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %f1_nof03 +
        [ 1610,  1610,  1610,  1610,  1610,  1610,  1610,  1610] * %f2_nof03 -
        [ 1815,  1815,  1815,  1815,  1815,  1815,  1815,  1815] * %f4_nof03
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\
...
cut (* 4 *)
    ...
    %v19 = [4, 4, 4, 4, 4, 4, 4, 4] * (
        %f0 +
        [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %f1 +
        [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %f2 +
        [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %f7 +
        [ 1610,  1610,  1610,  1610,  1610,  1610,  1610,  1610] * %f8 +
        [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %f9
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\
    ...
    %v18 = [4, 4, 4, 4, 4, 4, 4, 4] * (
        %f0 +
        [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %f1 +
        [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %f2 +
        [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %f7 +
        [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %f8 +
        [ 1610,  1610,  1610,  1610,  1610,  1610,  1610,  1610] * %f9
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\
    ...
    %v17 = [4, 4, 4, 4, 4, 4, 4, 4] * (
        %f0 +
        [ 1610,  1610,  1610,  1610,  1610,  1610,  1610,  1610] * %f1 +
        [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %f2 +
        [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %f7 +
        [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %f8 +
        [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %f9
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\
    ...
    %v7  = [4, 4, 4, 4, 4, 4, 4, 4] * (
        %f0 +
        [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %f1 +
        [ 1610,  1610,  1610,  1610,  1610,  1610,  1610,  1610] * %f2 +
        [ 1610,  1610,  1610,  1610,  1610,  1610,  1610,  1610] * %f7 +
        [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %f8 +
        [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %f9
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\
...
ghost
    %hh0@sint16[8], %hh1@sint16[8], %hh2@sint16[8], %hh3@sint16[8], %hh4@sint16[8],
    %hh5@sint16[8], %hh6@sint16[8], %hh7@sint16[8], %hh8@sint16[8], %hh9@sint16[8] :

    %hh0 = %v22 /\ %hh1 = %v6  /\ %hh2 = %v19 /\ %hh3 = %v5  /\ %hh4 = %v18 /\
    %hh5 = %v21 /\ %hh6 = %v17 /\ %hh7 = %v16 /\ %hh8 = %v7  /\ %hh9 = %v1
  &&
    %hh0 = %v22 /\ %hh1 = %v6  /\ %hh2 = %v19 /\ %hh3 = %v5  /\ %hh4 = %v18 /\
    %hh5 = %v21 /\ %hh6 = %v17 /\ %hh7 = %v16 /\ %hh8 = %v7  /\ %hh9 = %v1;
...
assert
    [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %hh1
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\
...
assert
    [1610, 1610, 1610, 1610, 1610, 1610, 1610, 1610] * %hh2
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\
...
assert
    [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %hh3
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\
...
assert
    [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %hh4
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\
...
assert
    [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %hh6
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\
...
assert
    [1610, 1610, 1610, 1610, 1610, 1610, 1610, 1610] * %hh7
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\
...
assert
    [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %hh8
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\
...
assert
    [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %hh9
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\
...
cut (* 5 *)
    ...
    %v6  = [4, 4, 4, 4, 4, 4, 4, 4] * (
        ...
        [ 1610,  1610,  1610,  1610,  1610,  1610,  1610,  1610] * %f8 +
        [ 1815,  1815,  1815,  1815,  1815,  1815,  1815,  1815] * %f9 +
        [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %f0 +
        [ 2113,  2113,  2113,  2113,  2113,  2113,  2113,  2113] * %f1
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\
    ...
    %v19 = [4, 4, 4, 4, 4, 4, 4, 4] * (
        ...
        [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %f8 +
        [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %f9 +
        [ 1610,  1610,  1610,  1610,  1610,  1610,  1610,  1610] * %f0 +
        [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %f1
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\
    ...
    %v5  = [4, 4, 4, 4, 4, 4, 4, 4] * (
        ...
        [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %f8 +
        [-1610, -1610, -1610, -1610, -1610, -1610, -1610, -1610] * %f9 +
        [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %f0 +
        [ 1815,  1815,  1815,  1815,  1815,  1815,  1815,  1815] * %f1
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\
    ...
    %v18 = [4, 4, 4, 4, 4, 4, 4, 4] * (
        ...
        [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %f8 +
        [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %f9 +
        [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %f0 +
        [ 1610,  1610,  1610,  1610,  1610,  1610,  1610,  1610] * %f1
    ) ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\
