...
output_lines += func_call('main_lay1__fwd_extract', poly_a_mem + arr_a_mem)
...
output_lines += func_call('main_lay2__fwd_inplace', arr_a_mem + arr_a_mem)
...
output_lines += func_call('main_lay1__fwd_extract', poly_b_mem + arr_b_mem)
...
output_lines += func_call('main_lay2__fwd_inplace', arr_b_mem + arr_b_mem)
...
output_lines += func_call('basemul__main_basemul', arr_a_mem + arr_b_mem + arr_c_mem)
...
output_lines += func_call('main_lay2__bwd_inplace', arr_c_mem + arr_c_mem)
...
output_lines += func_call('main_lay1__bwd_insert', arr_c_mem + full_main_part_mem)
