    ...
    for i in range(10):
        if i % 2 == 0:
            if isO1dbg:
                ...
                new_loc2 = annotator.find_first_line('PC = 0x5555551dd8', offset=2)
                new_loc3 = annotator.find_first_line('PC = 0x5555551df0', offset=2)
                new_loc4 = annotator.find_first_line('PC = 0x5555551dfc', offset=2)
                new_loc5 = annotator.find_first_line('PC = 0x5555551e34', offset=2)
                new_loc6 = annotator.find_first_line('PC = 0x5555551e4c', offset=2)
                new_loc7 = annotator.find_first_line('PC = 0x5555551e58', offset=2)
                new_loc8 = annotator.find_first_line('PC = 0x5555551e64', offset=2)
                new_loc9 = annotator.find_first_line('PC = 0x5555551e74', offset=2)
                new_loc10 = annotator.find_first_line('PC = 0x5555551e7c', offset=2)
                new_loc11 = annotator.find_first_line('PC = 0x5555551e80', offset=3)
                new_loc12 = annotator.find_first_line('PC = 0x5555551e8c', offset=2)
                new_loc13 = annotator.find_first_line('PC = 0x5555551e90', offset=5)
                new_loc14 = annotator.find_first_line('PC = 0x5555551ea0', offset=2)
                new_loc15 = annotator.find_first_line('PC = 0x5555551ea4', offset=3)
                new_loc16 = annotator.find_first_line('PC = 0x5555551eb0', offset=2)
                new_loc17 = annotator.find_first_line('PC = 0x5555551eb4', offset=5)
                output_lines += [
                ...
                new_loc1 = annotator.find_first_line('PC = 0x5555551ff8', offset=3)
                new_loc2 = annotator.find_first_line('PC = 0x5555552008', offset=2)
                new_loc3 = annotator.find_first_line('PC = 0x5555552044', offset=2)
                new_loc4 = annotator.find_first_line('PC = 0x5555552068', offset=2)
                new_loc5 = annotator.find_first_line('PC = 0x5555552078', offset=2)
                new_loc6 = annotator.find_first_line('PC = 0x5555552090', offset=2)
                new_loc7 = annotator.find_first_line('PC = 0x55555520a0', offset=2)
                new_loc8 = annotator.find_first_line('PC = 0x55555520b0', offset=2)
                new_loc9 = annotator.find_first_line('PC = 0x55555520bc', offset=2)
                new_loc10 = annotator.find_first_line('PC = 0x55555520c0', offset=3)
                new_loc11 = annotator.find_first_line('PC = 0x55555520d0', offset=2)
                new_loc12 = annotator.find_first_line('PC = 0x55555520d4', offset=3)
                new_loc13 = annotator.find_first_line('PC = 0x55555520dc', offset=2)
                new_loc14 = annotator.find_first_line('PC = 0x55555520e4', offset=5)
                new_loc15 = annotator.find_first_line('PC = 0x55555520ec', offset=2)
                new_loc16 = annotator.find_first_line('PC = 0x55555520f8', offset=5)
                output_lines += [
                    *annotator.lines[last_end : new_loc0],
                    '',
...
def annot(annotator, isO1dbg):
    ...
    def hints_rows(i):
        if i % 2 == 0:
            ...
            rows += [[Variable(f'mid{suffix}{mid_loc}_{i}_{k}', SINT16) for k in range(8)] for mid_loc in '356' for suffix in '01']
