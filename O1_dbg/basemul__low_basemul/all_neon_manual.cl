...
cut (* 13 *)
    ...
    true
    prove with [precondition, cuts[10, 11, 12]] # TODO
  &&
    true
    prove with [cuts[0]];
...
cut (* 16 *)
    ...
    true
    prove with [precondition, cuts[0, 15], algebra solver isl],
...
cut (* 22 *)
    ...
    true
    prove with [precondition, cuts[19, 20, 21]] # TODO
  &&
    true
    prove with [cuts[0]];
...
cut (* 25 *)
    ...
    true
    prove with [precondition, cuts[0, 24], algebra solver isl],
...
cut (* 31 *)
    ...
    true
    prove with [precondition, cuts[28, 29, 30]] # TODO
  &&
    true
    prove with [cuts[0]];
...
cut (* 40 *)
    ...
    true
    prove with [precondition, cuts[37, 38, 39]] # TODO
  &&
    true
    prove with [cuts[0]];
...
cut (* 43 *)
    ...
    true
    prove with [precondition, cuts[0, 42], algebra solver isl],
