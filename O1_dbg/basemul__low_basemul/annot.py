...
def annot_karatsuba_twist(conv, i, prologue_cut_id, load_cut_id):
    ...
    seg6_end = find_first_line(conv, 'PC = 0x5555551cd0', seg5_end)
    seg7_end = find_first_line(conv, 'PC = 0x5555551cd8', seg6_end)
    seg8_end = find_first_line(conv, 'PC = 0x5555551ce8', seg7_end)
    seg9_end = find_first_line(conv, 'PC = 0x5555551cf4', seg8_end)
    seg10_end = find_first_line(conv, 'PC = 0x5555551cfc', seg9_end)
    seg11_end = find_first_line(conv, 'PC = 0x5555551d0c', seg10_end)
...
cut (* {cut_id} *)
    ...
    %ffa0_{i} = %fa0_{i} ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\\
    %ffa1_{i} = %fa1_{i} ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\\
    %ffb0_{i} = %fb0_{i} ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\\
    %ffb1_{i} = %fb1_{i} ( mod [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] ) /\\
...
assert
    %v16[0] = (
        %ffa0_{i}[0] * %ffb0_{i}[0] + %ffa1_{i}[0] *  %gb1_{i}[0] +
        %ffa0_{i}[1] *  %gb1_{i}[7] + %ffa1_{i}[1] *  %gb0_{i}[7] +
        %ffa0_{i}[2] *  %gb1_{i}[6] + %ffa1_{i}[2] *  %gb0_{i}[6] +
        %ffa0_{i}[3] *  %gb1_{i}[5] + %ffa1_{i}[3] *  %gb0_{i}[5] +
        %ffa0_{i}[4] *  %gb1_{i}[4] + %ffa1_{i}[4] *  %gb0_{i}[4] +
        %ffa0_{i}[5] *  %gb1_{i}[3] + %ffa1_{i}[5] *  %gb0_{i}[3] +
        %ffa0_{i}[6] *  %gb1_{i}[2] + %ffa1_{i}[6] *  %gb0_{i}[2] +
        %ffa0_{i}[7] *  %gb1_{i}[1] + %ffa1_{i}[7] *  %gb0_{i}[1]
    ) /\\

    %v16[1] = (
        %ffa0_{i}[0] * %ffb0_{i}[1] + %ffa1_{i}[0] *  %gb1_{i}[1] +
        %ffa0_{i}[1] * %ffb0_{i}[0] + %ffa1_{i}[1] *  %gb1_{i}[0] +
        %ffa0_{i}[2] *  %gb1_{i}[7] + %ffa1_{i}[2] *  %gb0_{i}[7] +
        %ffa0_{i}[3] *  %gb1_{i}[6] + %ffa1_{i}[3] *  %gb0_{i}[6] +
        %ffa0_{i}[4] *  %gb1_{i}[5] + %ffa1_{i}[4] *  %gb0_{i}[5] +
        %ffa0_{i}[5] *  %gb1_{i}[4] + %ffa1_{i}[5] *  %gb0_{i}[4] +
        %ffa0_{i}[6] *  %gb1_{i}[3] + %ffa1_{i}[6] *  %gb0_{i}[3] +
        %ffa0_{i}[7] *  %gb1_{i}[2] + %ffa1_{i}[7] *  %gb0_{i}[2]
    ) /\\

    %v16[2] = (
        %ffa0_{i}[0] * %ffb0_{i}[2] + %ffa1_{i}[0] *  %gb1_{i}[2] +
        %ffa0_{i}[1] * %ffb0_{i}[1] + %ffa1_{i}[1] *  %gb1_{i}[1] +
        %ffa0_{i}[2] * %ffb0_{i}[0] + %ffa1_{i}[2] *  %gb1_{i}[0] +
        %ffa0_{i}[3] *  %gb1_{i}[7] + %ffa1_{i}[3] *  %gb0_{i}[7] +
        %ffa0_{i}[4] *  %gb1_{i}[6] + %ffa1_{i}[4] *  %gb0_{i}[6] +
        %ffa0_{i}[5] *  %gb1_{i}[5] + %ffa1_{i}[5] *  %gb0_{i}[5] +
        %ffa0_{i}[6] *  %gb1_{i}[4] + %ffa1_{i}[6] *  %gb0_{i}[4] +
        %ffa0_{i}[7] *  %gb1_{i}[3] + %ffa1_{i}[7] *  %gb0_{i}[3]
    ) /\\

    %v16[3] = (
        %ffa0_{i}[0] * %ffb0_{i}[3] + %ffa1_{i}[0] *  %gb1_{i}[3] +
        %ffa0_{i}[1] * %ffb0_{i}[2] + %ffa1_{i}[1] *  %gb1_{i}[2] +
        %ffa0_{i}[2] * %ffb0_{i}[1] + %ffa1_{i}[2] *  %gb1_{i}[1] +
        %ffa0_{i}[3] * %ffb0_{i}[0] + %ffa1_{i}[3] *  %gb1_{i}[0] +
        %ffa0_{i}[4] *  %gb1_{i}[7] + %ffa1_{i}[4] *  %gb0_{i}[7] +
        %ffa0_{i}[5] *  %gb1_{i}[6] + %ffa1_{i}[5] *  %gb0_{i}[6] +
        %ffa0_{i}[6] *  %gb1_{i}[5] + %ffa1_{i}[6] *  %gb0_{i}[5] +
        %ffa0_{i}[7] *  %gb1_{i}[4] + %ffa1_{i}[7] *  %gb0_{i}[4]
    ) /\\

    %v7 [0] = (
        %ffa0_{i}[0] * %ffb0_{i}[4] + %ffa1_{i}[0] *  %gb1_{i}[4] +
        %ffa0_{i}[1] * %ffb0_{i}[3] + %ffa1_{i}[1] *  %gb1_{i}[3] +
        %ffa0_{i}[2] * %ffb0_{i}[2] + %ffa1_{i}[2] *  %gb1_{i}[2] +
        %ffa0_{i}[3] * %ffb0_{i}[1] + %ffa1_{i}[3] *  %gb1_{i}[1] +
        %ffa0_{i}[4] * %ffb0_{i}[0] + %ffa1_{i}[4] *  %gb1_{i}[0] +
        %ffa0_{i}[5] *  %gb1_{i}[7] + %ffa1_{i}[5] *  %gb0_{i}[7] +
        %ffa0_{i}[6] *  %gb1_{i}[6] + %ffa1_{i}[6] *  %gb0_{i}[6] +
        %ffa0_{i}[7] *  %gb1_{i}[5] + %ffa1_{i}[7] *  %gb0_{i}[5]
    ) /\\

    %v7 [1] = (
        %ffa0_{i}[0] * %ffb0_{i}[5] + %ffa1_{i}[0] *  %gb1_{i}[5] +
        %ffa0_{i}[1] * %ffb0_{i}[4] + %ffa1_{i}[1] *  %gb1_{i}[4] +
        %ffa0_{i}[2] * %ffb0_{i}[3] + %ffa1_{i}[2] *  %gb1_{i}[3] +
        %ffa0_{i}[3] * %ffb0_{i}[2] + %ffa1_{i}[3] *  %gb1_{i}[2] +
        %ffa0_{i}[4] * %ffb0_{i}[1] + %ffa1_{i}[4] *  %gb1_{i}[1] +
        %ffa0_{i}[5] * %ffb0_{i}[0] + %ffa1_{i}[5] *  %gb1_{i}[0] +
        %ffa0_{i}[6] *  %gb1_{i}[7] + %ffa1_{i}[6] *  %gb0_{i}[7] +
        %ffa0_{i}[7] *  %gb1_{i}[6] + %ffa1_{i}[7] *  %gb0_{i}[6]
    ) /\\

    %v7 [2] = (
        %ffa0_{i}[0] * %ffb0_{i}[6] + %ffa1_{i}[0] *  %gb1_{i}[6] +
        %ffa0_{i}[1] * %ffb0_{i}[5] + %ffa1_{i}[1] *  %gb1_{i}[5] +
        %ffa0_{i}[2] * %ffb0_{i}[4] + %ffa1_{i}[2] *  %gb1_{i}[4] +
        %ffa0_{i}[3] * %ffb0_{i}[3] + %ffa1_{i}[3] *  %gb1_{i}[3] +
        %ffa0_{i}[4] * %ffb0_{i}[2] + %ffa1_{i}[4] *  %gb1_{i}[2] +
        %ffa0_{i}[5] * %ffb0_{i}[1] + %ffa1_{i}[5] *  %gb1_{i}[1] +
        %ffa0_{i}[6] * %ffb0_{i}[0] + %ffa1_{i}[6] *  %gb1_{i}[0] +
        %ffa0_{i}[7] *  %gb1_{i}[7] + %ffa1_{i}[7] *  %gb0_{i}[7]
    ) /\\

    %v7 [3] = (
        %ffa0_{i}[0] * %ffb0_{i}[7] + %ffa1_{i}[0] *  %gb1_{i}[7] +
        %ffa0_{i}[1] * %ffb0_{i}[6] + %ffa1_{i}[1] *  %gb1_{i}[6] +
        %ffa0_{i}[2] * %ffb0_{i}[5] + %ffa1_{i}[2] *  %gb1_{i}[5] +
        %ffa0_{i}[3] * %ffb0_{i}[4] + %ffa1_{i}[3] *  %gb1_{i}[4] +
        %ffa0_{i}[4] * %ffb0_{i}[3] + %ffa1_{i}[4] *  %gb1_{i}[3] +
        %ffa0_{i}[5] * %ffb0_{i}[2] + %ffa1_{i}[5] *  %gb1_{i}[2] +
        %ffa0_{i}[6] * %ffb0_{i}[1] + %ffa1_{i}[6] *  %gb1_{i}[1] +
        %ffa0_{i}[7] * %ffb0_{i}[0] + %ffa1_{i}[7] *  %gb1_{i}[0]
    ) /\\

    %v0 [0] = (
        %ffa0_{i}[0] * %ffb1_{i}[0] + %ffa1_{i}[0] * %ffb0_{i}[0] +
        %ffa0_{i}[1] * %ffb0_{i}[7] + %ffa1_{i}[1] *  %gb1_{i}[7] +
        %ffa0_{i}[2] * %ffb0_{i}[6] + %ffa1_{i}[2] *  %gb1_{i}[6] +
        %ffa0_{i}[3] * %ffb0_{i}[5] + %ffa1_{i}[3] *  %gb1_{i}[5] +
        %ffa0_{i}[4] * %ffb0_{i}[4] + %ffa1_{i}[4] *  %gb1_{i}[4] +
        %ffa0_{i}[5] * %ffb0_{i}[3] + %ffa1_{i}[5] *  %gb1_{i}[3] +
        %ffa0_{i}[6] * %ffb0_{i}[2] + %ffa1_{i}[6] *  %gb1_{i}[2] +
        %ffa0_{i}[7] * %ffb0_{i}[1] + %ffa1_{i}[7] *  %gb1_{i}[1]
    ) /\\

    %v0 [1] = (
        %ffa0_{i}[0] * %ffb1_{i}[1] + %ffa1_{i}[0] * %ffb0_{i}[1] +
        %ffa0_{i}[1] * %ffb1_{i}[0] + %ffa1_{i}[1] * %ffb0_{i}[0] +
        %ffa0_{i}[2] * %ffb0_{i}[7] + %ffa1_{i}[2] *  %gb1_{i}[7] +
        %ffa0_{i}[3] * %ffb0_{i}[6] + %ffa1_{i}[3] *  %gb1_{i}[6] +
        %ffa0_{i}[4] * %ffb0_{i}[5] + %ffa1_{i}[4] *  %gb1_{i}[5] +
        %ffa0_{i}[5] * %ffb0_{i}[4] + %ffa1_{i}[5] *  %gb1_{i}[4] +
        %ffa0_{i}[6] * %ffb0_{i}[3] + %ffa1_{i}[6] *  %gb1_{i}[3] +
        %ffa0_{i}[7] * %ffb0_{i}[2] + %ffa1_{i}[7] *  %gb1_{i}[2]
    ) /\\

    %v0 [2] = (
        %ffa0_{i}[0] * %ffb1_{i}[2] + %ffa1_{i}[0] * %ffb0_{i}[2] +
        %ffa0_{i}[1] * %ffb1_{i}[1] + %ffa1_{i}[1] * %ffb0_{i}[1] +
        %ffa0_{i}[2] * %ffb1_{i}[0] + %ffa1_{i}[2] * %ffb0_{i}[0] +
        %ffa0_{i}[3] * %ffb0_{i}[7] + %ffa1_{i}[3] *  %gb1_{i}[7] +
        %ffa0_{i}[4] * %ffb0_{i}[6] + %ffa1_{i}[4] *  %gb1_{i}[6] +
        %ffa0_{i}[5] * %ffb0_{i}[5] + %ffa1_{i}[5] *  %gb1_{i}[5] +
        %ffa0_{i}[6] * %ffb0_{i}[4] + %ffa1_{i}[6] *  %gb1_{i}[4] +
        %ffa0_{i}[7] * %ffb0_{i}[3] + %ffa1_{i}[7] *  %gb1_{i}[3]
    ) /\\

    %v0 [3] = (
        %ffa0_{i}[0] * %ffb1_{i}[3] + %ffa1_{i}[0] * %ffb0_{i}[3] +
        %ffa0_{i}[1] * %ffb1_{i}[2] + %ffa1_{i}[1] * %ffb0_{i}[2] +
        %ffa0_{i}[2] * %ffb1_{i}[1] + %ffa1_{i}[2] * %ffb0_{i}[1] +
        %ffa0_{i}[3] * %ffb1_{i}[0] + %ffa1_{i}[3] * %ffb0_{i}[0] +
        %ffa0_{i}[4] * %ffb0_{i}[7] + %ffa1_{i}[4] *  %gb1_{i}[7] +
        %ffa0_{i}[5] * %ffb0_{i}[6] + %ffa1_{i}[5] *  %gb1_{i}[6] +
        %ffa0_{i}[6] * %ffb0_{i}[5] + %ffa1_{i}[6] *  %gb1_{i}[5] +
        %ffa0_{i}[7] * %ffb0_{i}[4] + %ffa1_{i}[7] *  %gb1_{i}[4]
    ) /\\

    %v2 [0] = (
        %ffa0_{i}[0] * %ffb1_{i}[4] + %ffa1_{i}[0] * %ffb0_{i}[4] +
        %ffa0_{i}[1] * %ffb1_{i}[3] + %ffa1_{i}[1] * %ffb0_{i}[3] +
        %ffa0_{i}[2] * %ffb1_{i}[2] + %ffa1_{i}[2] * %ffb0_{i}[2] +
        %ffa0_{i}[3] * %ffb1_{i}[1] + %ffa1_{i}[3] * %ffb0_{i}[1] +
        %ffa0_{i}[4] * %ffb1_{i}[0] + %ffa1_{i}[4] * %ffb0_{i}[0] +
        %ffa0_{i}[5] * %ffb0_{i}[7] + %ffa1_{i}[5] *  %gb1_{i}[7] +
        %ffa0_{i}[6] * %ffb0_{i}[6] + %ffa1_{i}[6] *  %gb1_{i}[6] +
        %ffa0_{i}[7] * %ffb0_{i}[5] + %ffa1_{i}[7] *  %gb1_{i}[5]
    ) /\\

    %v2 [1] = (
        %ffa0_{i}[0] * %ffb1_{i}[5] + %ffa1_{i}[0] * %ffb0_{i}[5] +
        %ffa0_{i}[1] * %ffb1_{i}[4] + %ffa1_{i}[1] * %ffb0_{i}[4] +
        %ffa0_{i}[2] * %ffb1_{i}[3] + %ffa1_{i}[2] * %ffb0_{i}[3] +
        %ffa0_{i}[3] * %ffb1_{i}[2] + %ffa1_{i}[3] * %ffb0_{i}[2] +
        %ffa0_{i}[4] * %ffb1_{i}[1] + %ffa1_{i}[4] * %ffb0_{i}[1] +
        %ffa0_{i}[5] * %ffb1_{i}[0] + %ffa1_{i}[5] * %ffb0_{i}[0] +
        %ffa0_{i}[6] * %ffb0_{i}[7] + %ffa1_{i}[6] *  %gb1_{i}[7] +
        %ffa0_{i}[7] * %ffb0_{i}[6] + %ffa1_{i}[7] *  %gb1_{i}[6]
    ) /\\

    %v2 [2] = (
        %ffa0_{i}[0] * %ffb1_{i}[6] + %ffa1_{i}[0] * %ffb0_{i}[6] +
        %ffa0_{i}[1] * %ffb1_{i}[5] + %ffa1_{i}[1] * %ffb0_{i}[5] +
        %ffa0_{i}[2] * %ffb1_{i}[4] + %ffa1_{i}[2] * %ffb0_{i}[4] +
        %ffa0_{i}[3] * %ffb1_{i}[3] + %ffa1_{i}[3] * %ffb0_{i}[3] +
        %ffa0_{i}[4] * %ffb1_{i}[2] + %ffa1_{i}[4] * %ffb0_{i}[2] +
        %ffa0_{i}[5] * %ffb1_{i}[1] + %ffa1_{i}[5] * %ffb0_{i}[1] +
        %ffa0_{i}[6] * %ffb1_{i}[0] + %ffa1_{i}[6] * %ffb0_{i}[0] +
        %ffa0_{i}[7] * %ffb0_{i}[7] + %ffa1_{i}[7] *  %gb1_{i}[7]
    ) /\\

    %v2 [3] = (
        %ffa0_{i}[0] * %ffb1_{i}[7] + %ffa1_{i}[0] * %ffb0_{i}[7] +
        %ffa0_{i}[1] * %ffb1_{i}[6] + %ffa1_{i}[1] * %ffb0_{i}[6] +
        %ffa0_{i}[2] * %ffb1_{i}[5] + %ffa1_{i}[2] * %ffb0_{i}[5] +
        %ffa0_{i}[3] * %ffb1_{i}[4] + %ffa1_{i}[3] * %ffb0_{i}[4] +
        %ffa0_{i}[4] * %ffb1_{i}[3] + %ffa1_{i}[4] * %ffb0_{i}[3] +
        %ffa0_{i}[5] * %ffb1_{i}[2] + %ffa1_{i}[5] * %ffb0_{i}[2] +
        %ffa0_{i}[6] * %ffb1_{i}[1] + %ffa1_{i}[6] * %ffb0_{i}[1] +
        %ffa0_{i}[7] * %ffb1_{i}[0] + %ffa1_{i}[7] * %ffb0_{i}[0]
    )
    && true;
...
''')
    ...
    print(f'''
ghost %h0_0_{i}@sint32[4], %h0_1_{i}@sint32[4], %h1_0_{i}@sint32[4], %h1_1_{i}@sint32[4] :
    %h0_0_{i} = %v16 /\\ %h0_1_{i} = %v7 /\\
    %h1_0_{i} = %v0  /\\ %h1_1_{i} = %v2
  &&
    %h0_0_{i} = %v16 /\\ %h0_1_{i} = %v7 /\\
    %h1_0_{i} = %v0  /\\ %h1_1_{i} = %v2;
''')
    ...
    print(''.join(seg7), end='')
    print(f'''
ghost %m0_{i}@sint16[8] : %m0_{i} = %v3 && %m0_{i} = %v3;
''')
...
''')
    ...
    print(''.join(seg10), end='')
    print(f'''
ghost %m1_{i}@sint16[8] : %m1_{i} = %v3 && %m1_{i} = %v3;
''')
...
''')
    ...
    print(f'''
assert
    {format_coefs([consts_table[i][2]] * 8)} * %hh1_{i}
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v2
    = %v0
    prove with [algebra solver isl]
    && true;
