...
''')
    ...
    print(f'''
assert
    [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %hha1_{j}{k0}
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\\
...
''')
    ...
    print(f'''
assert
    [1610, 1610, 1610, 1610, 1610, 1610, 1610, 1610] * %hha2_{j}{k0}
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\\
...
''')
    ...
    print(f'''
assert
    [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %hha3_{j}{k0}
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\\
...
''')
    ...
    print(f'''
assert
    [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %hha4_{j}{k0}
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\\
...
''')
    ...
    print(f'''
assert
    [-2274, -2274, -2274, -2274, -2274, -2274, -2274, -2274] * %hha6_{j}{k0}
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\\
...
''')
    ...
    print(f'''
assert
    [1610, 1610, 1610, 1610, 1610, 1610, 1610, 1610] * %hha7_{j}{k0}
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\\
...
''')
    ...
    print(f'''
assert
    [-2113, -2113, -2113, -2113, -2113, -2113, -2113, -2113] * %hha8_{j}{k0}
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\\
...
''')
    ...
    print(f'''
assert
    [-1815, -1815, -1815, -1815, -1815, -1815, -1815, -1815] * %hha9_{j}{k0}
    - [4591, 4591, 4591, 4591, 4591, 4591, 4591, 4591] * %v20
    <= [32767, 32767, 32767, 32767, 32767, 32767, 32767, 32767] /\\
...
def annot(lines):
    ...
    print()
    for j in range(9):
        # FIXME: use correct twist consts
        twist_consts = twist_table[0]
