...
cut (* {cut_id} *)
    ...
    %v17 <= [2500, 2500, 2500, 2500, 2500, 2500, 2500, 2500] /\\
    %v17 >= [-2500, -2500, -2500, -2500, -2500, -2500, -2500, -2500] /\\

    %v16 <= [4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000] /\\
    %v16 >= [-4000, -4000, -4000, -4000, -4000, -4000, -4000, -4000] /\\

    %v0  <= [4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000] /\\
    %v0  >= [-4000, -4000, -4000, -4000, -4000, -4000, -4000, -4000] /\\

    %v6  <= [15000, 15000, 15000, 15000, 15000, 15000, 15000, 15000] /\\
    %v6  >= [-15000, -15000, -15000, -15000, -15000, -15000, -15000, -15000] /\\

    %v3  <= [22500, 22500, 22500, 22500, 22500, 22500, 22500, 22500] /\\
    %v3  >= [-22500, -22500, -22500, -22500, -22500, -22500, -22500, -22500] /\\

    %v7  <= [22500, 22500, 22500, 22500, 22500, 22500, 22500, 22500] /\\
    %v7  >= [-22500, -22500, -22500, -22500, -22500, -22500, -22500, -22500] /\\

    %v19 <= [15000, 15000, 15000, 15000, 15000, 15000, 15000, 15000] /\\
    %v19 >= [-15000, -15000, -15000, -15000, -15000, -15000, -15000, -15000] /\\

    %v1  <= [22500, 22500, 22500, 22500, 22500, 22500, 22500, 22500] /\\
    %v1  >= [-22500, -22500, -22500, -22500, -22500, -22500, -22500, -22500] /\\

    %v2  <= [22500, 22500, 22500, 22500, 22500, 22500, 22500, 22500] /\\
    %v2  >= [-22500, -22500, -22500, -22500, -22500, -22500, -22500, -22500] /\\
  ...
  &&
    ...
    %v17 <=s [2500@16, 2500@16, 2500@16, 2500@16, 2500@16, 2500@16, 2500@16, 2500@16] /\\
    %v17 >=s [(-2500)@16, (-2500)@16, (-2500)@16, (-2500)@16, (-2500)@16, (-2500)@16, (-2500)@16, (-2500)@16] /\\

    %v16 <=s [4000@16, 4000@16, 4000@16, 4000@16, 4000@16, 4000@16, 4000@16, 4000@16] /\\
    %v16 >=s [(-4000)@16, (-4000)@16, (-4000)@16, (-4000)@16, (-4000)@16, (-4000)@16, (-4000)@16, (-4000)@16] /\\
    ...
    %v3  <=s [22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16] /\\
    %v3  >=s [(-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16] /\\

    %v7  <=s [22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16] /\\
    %v7  >=s [(-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16] /\\

    %v19 <=s [15000@16, 15000@16, 15000@16, 15000@16, 15000@16, 15000@16, 15000@16, 15000@16] /\\
    %v19 >=s [(-15000)@16, (-15000)@16, (-15000)@16, (-15000)@16, (-15000)@16, (-15000)@16, (-15000)@16, (-15000)@16] /\\

    %v1  <=s [22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16] /\\
    %v1  >=s [(-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16] /\\

    %v2  <=s [22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16, 22500@16] /\\
    %v2  >=s [(-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16, (-22500)@16] /\\
...
assert
    %v6  <= [4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000] /\\
    %v6  >= [-4000, -4000, -4000, -4000, -4000, -4000, -4000, -4000]
    prove with [precondition, algebra solver isl] && true;
...
assume
    ...
    %v6  >= [-4000, -4000, -4000, -4000, -4000, -4000, -4000, -4000]
  &&
    %v6  <=s [4000@16, 4000@16, 4000@16, 4000@16, 4000@16, 4000@16, 4000@16, 4000@16] /\\
    %v6  >=s [(-4000)@16, (-4000)@16, (-4000)@16, (-4000)@16, (-4000)@16, (-4000)@16, (-4000)@16, (-4000)@16];
''')
    print(''.join(seg8), end='')
    print(f'''
...
''')
    ...
    {memory_arr(0x7ffffff070, 8, 2)} <= {format_coefs([7500] * 8)} /\\
    {memory_arr(0x7ffffff070, 8, 2)} >= {format_coefs([-7500] * 8)} /\\

    {memory_arr(0x7ffffff080, 8, 2)} <= {format_coefs([9000] * 8)} /\\
    {memory_arr(0x7ffffff080, 8, 2)} >= {format_coefs([-9000] * 8)} /\\

    {memory_arr(0x7ffffff090, 8, 2)} <= {format_coefs([9000] * 8)} /\\
    {memory_arr(0x7ffffff090, 8, 2)} >= {format_coefs([-9000] * 8)} /\\

    {memory_arr(0x7ffffff0a0, 8, 2)} <= {format_coefs([9000] * 8)} /\\
    {memory_arr(0x7ffffff0a0, 8, 2)} >= {format_coefs([-9000] * 8)} /\\

    {memory_arr(0x7ffffff0b0, 8, 2)} <= {format_coefs([10500] * 8)} /\\
    {memory_arr(0x7ffffff0b0, 8, 2)} >= {format_coefs([-10500] * 8)} /\\

    {memory_arr(0x7ffffff0c0, 8, 2)} <= {format_coefs([10500] * 8)} /\\
    {memory_arr(0x7ffffff0c0, 8, 2)} >= {format_coefs([-10500] * 8)} /\\

    {memory_arr(0x7ffffff0d0, 8, 2)} <= {format_coefs([9000] * 8)} /\\
    {memory_arr(0x7ffffff0d0, 8, 2)} >= {format_coefs([-9000] * 8)} /\\

    {memory_arr(0x7ffffff0e0, 8, 2)} <= {format_coefs([10500] * 8)} /\\
    {memory_arr(0x7ffffff0e0, 8, 2)} >= {format_coefs([-10500] * 8)} /\\

    {memory_arr(0x7ffffff0f0, 8, 2)} <= {format_coefs([10500] * 8)} /\\
    {memory_arr(0x7ffffff0f0, 8, 2)} >= {format_coefs([-10500] * 8)} /\\
